...
class NowkoellnScraper(BaseScraper):
    ...
    def scrape(self) -> list[dict[str, Any]]:
        ...
        for d in dates:
            events.append({
                ...
                "tags": ["flea market", "secondhand", "handmade", "outdoor", "neukölln", "maybachufer", "free entry"],
                "source_tags": [],
    ...
    def _generate_recurring_dates(self) -> list[date]:
        ...
        current = next_sunday
        end_date = today.replace(month=today.month + 6 if today.month <= 6 else today.month - 6,
