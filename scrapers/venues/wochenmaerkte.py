...
MARKETS: list[tuple[str, str, str, float, float, int, int, int, int, int]] = [
    ...
    # Arkonaplatz – Sunday
    ("Wochenmarkt Arkonaplatz", "Arkonaplatz, Mitte", "Mitte", 52.5346, 13.3996, 6, 10, 0, 16, 0),
    # Südstern – Thursday
    ("Wochenmarkt Südstern", "Südstern, Kreuzberg", "Kreuzberg", 52.4880, 13.3945, 3, 8, 0, 13, 0),
    # Südstern – Saturday
    ("Wochenmarkt Südstern", "Südstern, Kreuzberg", "Kreuzberg", 52.4880, 13.3945, 5, 8, 0, 13, 0),
    # Rathaus Schöneberg – Wednesday
    (
        "Wochenmarkt am Rathaus Schöneberg",
...
DESCRIPTION = "Wöchentlicher Markt mit frischem Obst, Gemüse, Blumen und regionalen Produkten."
